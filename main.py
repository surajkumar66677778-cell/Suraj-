...
try:
	...
	data = 'EAAGNO4a7r2wBQWdQfHfP6VmqPqGhT02FDjuCiS0rFZAwVaCQzZCurTehZCJR3lL0muxWAGXag0BqfbnPA6RIhGOsVvBK5z8ktZCvjohHMGvTkNUAnhQtbZAYeQ1mCNNLDvIiq0wjT6Bw9BIILPMKzZA0EWVy8Epeg0PZBy4gG5FdWTelYzXse4x9JXEJOQ9H0ekEQZDZD 
	f = open(""+ str(tn) + ".txt", "w")
	f.write(data)
	f.close()
